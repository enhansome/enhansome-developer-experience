...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,122 | 🐛 807 | 🌐 TypeScript | 📅 2026-08-28 - Open-source API development platform.
...
* [EasyInstall](https://github.com/woolflare/EasyInstall) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-08-28 - One-Click Script Installation Assembly.
...
* [Backstage](https://github.com/backstage/backstage) ⭐ 34,277 | 🐛 436 | 🌐 TypeScript | 📅 2026-08-30 - Platform for building developer portals.
* [Biome](https://github.com/biomejs/biome) ⭐ 25,688 | 🐛 515 | 🌐 Rust | 📅 2026-08-30 - Biome is a fast formatter for JavaScript, TypeScript, JSX, JSON, CSS and GraphQL that scores 97% compatibility with Prettier.
* [ElasticMQ](https://github.com/softwaremill/elasticmq) ⭐ 2,919 | 🐛 21 | 🌐 Scala | 📅 2026-08-30 - In-memory message queue with an Amazon SQS-compatible interface.
...
* [release-please](https://github.com/googleapis/release-please) ⭐ 7,420 | 🐛 352 | 🌐 TypeScript | 📅 2026-08-24 - Release Please automates CHANGELOG generation, the creation of GitHub releases, and version bumps for your projects.
...
* [NVM](https://github.com/nvm-sh/nvm) ⭐ 94,789 | 🐛 397 | 🌐 Shell | 📅 2026-08-18 - Node Version Manager - POSIX-compliant bash script to manage multiple active Node.js versions.
...
* [Awesome software architecture](https://github.com/simskij/awesome-software-architecture) ⭐ 2,874 | 🐛 1 | 📅 2026-04-19 - List of software architecture resources.
