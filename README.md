...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,364 | 🐛 826 | 🌐 TypeScript | 📅 2026-09-16 - Open-source API development platform.
...
* [EasyInstall](https://github.com/woolflare/EasyInstall) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - One-Click Script Installation Assembly.
...
* [Backstage](https://github.com/backstage/backstage) ⭐ 34,452 | 🐛 434 | 🌐 TypeScript | 📅 2026-09-19 - Platform for building developer portals.
* [Biome](https://github.com/biomejs/biome) ⭐ 25,827 | 🐛 402 | 🌐 Rust | 📅 2026-09-20 - Biome is a fast formatter for JavaScript, TypeScript, JSX, JSON, CSS and GraphQL that scores 97% compatibility with Prettier.
...
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,050 | 🐛 406 | 🌐 JavaScript | 📅 2026-09-19 - Fully automated package publishing.
* [release-please](https://github.com/googleapis/release-please) ⭐ 7,521 | 🐛 356 | 🌐 TypeScript | 📅 2026-09-14 - Release Please automates CHANGELOG generation, the creation of GitHub releases, and version bumps for your projects.
...
* [NVM](https://github.com/nvm-sh/nvm) ⭐ 95,131 | 🐛 391 | 🌐 Shell | 📅 2026-09-11 - Node Version Manager - POSIX-compliant bash script to manage multiple active Node.js versions.
