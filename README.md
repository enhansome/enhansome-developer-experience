...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,094 | 🐛 802 | 🌐 TypeScript | 📅 2026-08-24 - Open-source API development platform.
...
* [Backstage](https://github.com/backstage/backstage) ⭐ 34,236 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-24 - Platform for building developer portals.
* [Biome](https://github.com/biomejs/biome) ⭐ 25,639 | 🐛 519 | 🌐 Rust | 📅 2026-08-25 - Biome is a fast formatter for JavaScript, TypeScript, JSX, JSON, CSS and GraphQL that scores 97% compatibility with Prettier.
* [ElasticMQ](https://github.com/softwaremill/elasticmq) ⭐ 2,916 | 🐛 21 | 🌐 Scala | 📅 2026-08-25 - In-memory message queue with an Amazon SQS-compatible interface.
...
* [release-please](https://github.com/googleapis/release-please) ⭐ 7,388 | 🐛 348 | 🌐 TypeScript | 📅 2026-08-24 - Release Please automates CHANGELOG generation, the creation of GitHub releases, and version bumps for your projects.
...
* [NVM](https://github.com/nvm-sh/nvm) ⭐ 94,725 | 🐛 394 | 🌐 Shell | 📅 2026-08-18 - Node Version Manager - POSIX-compliant bash script to manage multiple active Node.js versions.
